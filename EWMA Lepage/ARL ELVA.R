###############################################################################
# EWMA Lepage (VW–AB) Control Chart based Simulation
#
# Purpose:
#   Compute the Zero-State Average Run Length (ZSARL) and Steady-State 
#   Average Run Length (SSARL) for the EWMA Lepage EL(V,A) 
...
#   a specified distribution and computing the EL(V,A) statistic sequentially 
