...
ARL_graph <- create_plot(plot_df,"E_VWAB",0,2.200,bquote(EL["V,A"]))
print(ARL_graph)

ARL_graph <- create_plot(plot_df,"E_VWM",0,2.195,bquote(EL["V,M"]))
print(ARL_graph)

ARL_graph <- create_plot(plot_df,"E_WRSAB",0,2.205,bquote(EL["W,A"]))
print(ARL_graph)

ARL_graph <- create_plot(plot_df,"E_C",0,1.100,bquote('EWMA Cucconi'))
print(ARL_graph)


# Save the final data set
output_file <- "Example Piston Ring Diameter Statistics for n=5 .csv"
