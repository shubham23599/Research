###############################################################################
# EWMA Lepage (VW–Mood) Control Chart Simulation
# Purpose:
#   Compute the Zero-State Out-of-Control ARL and SDRL for the EWMA Lepage
#   VW–Mood control chart under location/scale shifts.
#
###############################################################################
